...
type props = {
  ...
  ref : (Dom.element Js.nullable -> unit) option; [@mel.optional]
  ...
  ariaAutocomplete : string option;
      [@mel.optional] [@mel.as "aria-autocomplete"]
  ariaBusy : bool option; [@mel.optional] [@mel.as "aria-busy"]
  ariaChecked : string option; [@mel.optional] [@mel.as "aria-checked"]
  ...
  ariaCurrent : string option; [@mel.optional] [@mel.as "aria-current"]
  ...
  ariaHaspopup : string option; [@mel.optional] [@mel.as "aria-haspopup"]
  ariaHidden : bool option; [@mel.optional] [@mel.as "aria-hidden"]
  ariaInvalid : string option; [@mel.optional] [@mel.as "aria-invalid"]
  ...
  ariaLive : string option; [@mel.optional] [@mel.as "aria-live"]
  ...
  ariaPressed : string option; [@mel.optional] [@mel.as "aria-pressed"]
  ...
  ariaRowindextext : string option;
  ...
  style : style option; [@mel.optional]
  ...
  as_ : string option; [@mel.optional] [@mel.as "as"]
  ...
  autoCapitalize : string option; [@mel.optional]
  ...
  _method : string option; [@mel.optional]
  min : string option; [@mel.optional]
  ...
  open_ : bool option; [@mel.optional] [@mel.as "open"]
  ...
  onCopy : (Event.Clipboard.t -> unit) option; [@mel.optional]
  onCut : (Event.Clipboard.t -> unit) option; [@mel.optional]
  onPaste : (Event.Clipboard.t -> unit) option; [@mel.optional]
  onCompositionEnd : (Event.Composition.t -> unit) option; [@mel.optional]
  onCompositionStart : (Event.Composition.t -> unit) option;
      [@mel.optional]
  onCompositionUpdate : (Event.Composition.t -> unit) option;
      [@mel.optional]
  onKeyDown : (Event.Keyboard.t -> unit) option; [@mel.optional]
  onKeyPress : (Event.Keyboard.t -> unit) option; [@mel.optional]
  onKeyUp : (Event.Keyboard.t -> unit) option; [@mel.optional]
  onFocus : (Event.Focus.t -> unit) option; [@mel.optional]
  onBlur : (Event.Focus.t -> unit) option; [@mel.optional]
  onChange : (Event.Form.t -> unit) option; [@mel.optional]
  onInput : (Event.Form.t -> unit) option; [@mel.optional]
  onSubmit : (Event.Form.t -> unit) option; [@mel.optional]
  onInvalid : (Event.Form.t -> unit) option; [@mel.optional]
  onClick : (Event.Mouse.t -> unit) option; [@mel.optional]
  onContextMenu : (Event.Mouse.t -> unit) option; [@mel.optional]
  onDoubleClick : (Event.Mouse.t -> unit) option; [@mel.optional]
  onDrag : (Event.Drag.t -> unit) option; [@mel.optional]
  onDragEnd : (Event.Drag.t -> unit) option; [@mel.optional]
  onDragEnter : (Event.Drag.t -> unit) option; [@mel.optional]
  onDragExit : (Event.Drag.t -> unit) option; [@mel.optional]
  onDragLeave : (Event.Drag.t -> unit) option; [@mel.optional]
  onDragOver : (Event.Drag.t -> unit) option; [@mel.optional]
  onDragStart : (Event.Drag.t -> unit) option; [@mel.optional]
  onDrop : (Event.Drag.t -> unit) option; [@mel.optional]
  onMouseDown : (Event.Mouse.t -> unit) option; [@mel.optional]
  onMouseEnter : (Event.Mouse.t -> unit) option; [@mel.optional]
  onMouseLeave : (Event.Mouse.t -> unit) option; [@mel.optional]
  onMouseMove : (Event.Mouse.t -> unit) option; [@mel.optional]
  onMouseOut : (Event.Mouse.t -> unit) option; [@mel.optional]
  onMouseOver : (Event.Mouse.t -> unit) option; [@mel.optional]
  onMouseUp : (Event.Mouse.t -> unit) option; [@mel.optional]
  onSelect : (Event.Selection.t -> unit) option; [@mel.optional]
  onTouchCancel : (Event.Touch.t -> unit) option; [@mel.optional]
  onTouchEnd : (Event.Touch.t -> unit) option; [@mel.optional]
  onTouchMove : (Event.Touch.t -> unit) option; [@mel.optional]
  onTouchStart : (Event.Touch.t -> unit) option; [@mel.optional]
  onPointerOver : (Event.Pointer.t -> unit) option; [@mel.optional]
  onPointerEnter : (Event.Pointer.t -> unit) option; [@mel.optional]
  onPointerDown : (Event.Pointer.t -> unit) option; [@mel.optional]
  onPointerMove : (Event.Pointer.t -> unit) option; [@mel.optional]
  onPointerUp : (Event.Pointer.t -> unit) option; [@mel.optional]
  onPointerCancel : (Event.Pointer.t -> unit) option; [@mel.optional]
  onPointerOut : (Event.Pointer.t -> unit) option; [@mel.optional]
  onPointerLeave : (Event.Pointer.t -> unit) option; [@mel.optional]
  onGotPointerCapture : (Event.Pointer.t -> unit) option; [@mel.optional]
  onLostPointerCapture : (Event.Pointer.t -> unit) option; [@mel.optional]
  onScroll : (Event.UI.t -> unit) option; [@mel.optional]
  onWheel : (Event.Wheel.t -> unit) option; [@mel.optional]
  onAbort : (Event.Media.t -> unit) option; [@mel.optional]
  onCanPlay : (Event.Media.t -> unit) option; [@mel.optional]
  onCanPlayThrough : (Event.Media.t -> unit) option; [@mel.optional]
  onDurationChange : (Event.Media.t -> unit) option; [@mel.optional]
  onEmptied : (Event.Media.t -> unit) option; [@mel.optional]
  onEncrypetd : (Event.Media.t -> unit) option; [@mel.optional]
  onEnded : (Event.Media.t -> unit) option; [@mel.optional]
  onError : (Event.Media.t -> unit) option; [@mel.optional]
  onLoadedData : (Event.Media.t -> unit) option; [@mel.optional]
  onLoadedMetadata : (Event.Media.t -> unit) option; [@mel.optional]
  onLoadStart : (Event.Media.t -> unit) option; [@mel.optional]
  onPause : (Event.Media.t -> unit) option; [@mel.optional]
  onPlay : (Event.Media.t -> unit) option; [@mel.optional]
  onPlaying : (Event.Media.t -> unit) option; [@mel.optional]
  onProgress : (Event.Media.t -> unit) option; [@mel.optional]
  onRateChange : (Event.Media.t -> unit) option; [@mel.optional]
  onSeeked : (Event.Media.t -> unit) option; [@mel.optional]
  onSeeking : (Event.Media.t -> unit) option; [@mel.optional]
  onStalled : (Event.Media.t -> unit) option; [@mel.optional]
  onSuspend : (Event.Media.t -> unit) option; [@mel.optional]
  onTimeUpdate : (Event.Media.t -> unit) option; [@mel.optional]
  onVolumeChange : (Event.Media.t -> unit) option; [@mel.optional]
  onWaiting : (Event.Media.t -> unit) option; [@mel.optional]
  onLoad : (Event.Image.t -> unit) option; [@mel.optional]
  onAnimationStart : (Event.Animation.t -> unit) option; [@mel.optional]
  onAnimationEnd : (Event.Animation.t -> unit) option; [@mel.optional]
  onAnimationIteration : (Event.Animation.t -> unit) option;
      [@mel.optional]
  onTransitionEnd : (Event.Transition.t -> unit) option; [@mel.optional]
  ...
  begin_ : string option; [@mel.optional] [@mel.as "begin"]
  ...
  end_ : string option; [@mel.optional] [@mel.as "end"]
  ...
  in_ : string option; [@mel.optional] [@mel.as "in"]
  ...
  string : string option; [@mel.optional]
  ...
  to_ : string option; [@mel.optional] [@mel.as "to"]
  ...
  dangerouslySetInnerHTML : unsafeHTML option; [@mel.optional]
  suppressHydrationWarning : bool option option; [@mel.optional]
